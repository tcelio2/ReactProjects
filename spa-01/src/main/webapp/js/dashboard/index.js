...
//		makeView(values);
	...
	$(document).on("click", "#update_btn_especial", function(e){
			
			$(".pop-up-edit-especial").fadeOut(1000);
			var fieldset = $(".pop-up-edit-especial").attr("fieldset");
			var id_row = $(".pop-up-edit-especial").attr("id");
			var table_column = $(".pop-up-edit-especial select").attr("id");
			var input_value = $(".status_led option:selected").attr("id");
			var tab = $(".pop-up-edit-especial").attr("tab");
			var bgColor = $(".pop-up-edit-especial").attr("bgColor");
			var tab_especial = $(".pop-up-edit-especial").attr("tab_especial");
			
			//$(".dropdown_filter_manager option:selected").attr("id");//text();
								...
								$("."+fieldset).find('#'+tab).find(".rTable2 .rTableRow").each(function(){
										...
										if(id == id_row){
											if(input_value == "Green"){
												$(this).find('#'+table_column).html('<img style="height:12px" src="img/green_icon.png">').animate({backgroundColor: '#FFFF00'}, 'slow').animate({backgroundColor: bgColor}, 2000);	
											}
											if(input_value == "Yellow"){
												$(this).find('#'+table_column).html('<img style="height:12px" src="img/yellow_icon.png">').animate({backgroundColor: '#FFFF00'}, 'slow').animate({backgroundColor: bgColor}, 2000);									
											}
											if(input_value == "Red"){
												$(this).find('#'+table_column).html('<img style="height:12px" src="img/red_icon.png">').animate({backgroundColor: '#FFFF00'}, 'slow').animate({backgroundColor: bgColor}, 2000);	
											}
										}
									})
							}
		...
		$(".rTableCell+.edit_especial_one_").click(function(e){
			...
			$(".pop-up-edit-especial").attr("fieldset", fieldset);
			$(".pop-up-edit-especial").attr("id", id_row);
			$(".pop-up-edit-especial").css({"top":position.top});

			$(".pop-up-edit-especialt option[value='']").attr('selected', true);

			//$(".pop-up-edit-especial s").val("");
			//$(".pop-up-edit-especial input").val(c);
			$(".pop-up-edit-especial select").attr("id",column_table);
			$(".pop-up-edit-especial").attr("tab", tab);
			$(".pop-up-edit-especial").attr("bgColor", bgColor);
			$(".pop-up-edit-especial").show();
